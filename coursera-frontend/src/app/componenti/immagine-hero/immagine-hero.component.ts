...
@Component({
  selector: 'app-immagine-hero',
  templateUrl: './immagine-hero.component.html',
  styleUrls: ['./immagine-hero.component.css']
})
export class ImmagineHeroComponent {
  urlImgHero: string = "https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://images.ctfassets.net/wp1lcwdav1p1/5CFC8u8XiXcbSOlVv6JZQx/4e6f898f57f9d798437b3aa22026e30b/CourseraLearners_C_Composition_Hillary_copy__3_.png?auto=format%2Ccompress&dpr=2&w=459&h=497&q=40";
